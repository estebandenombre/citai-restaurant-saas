...
export default function Cart({ 
  ...
  console.log('Cart component - totalItems:', getTotalItems())
  ...
  return (
    <>
      ...
      <Button
        variant="outline"
        size="sm"
        className="fixed bottom-6 left-6 z-50 shadow-lg bg-red-500 text-white hover:bg-red-600"
        onClick={() => {
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">
                              <FormattedPrice amount={item.price} className="text-sm text-gray-600" restaurantId={restaurantId} />
                            </p>
                          </div>
                          <Button
                            variant="ghost"
                        ...
                        <div className="flex items-center justify-between mt-3">
                          ...
                          <span className="font-semibold text-sm">
                            <FormattedPrice amount={item.price * item.quantity} restaurantId={restaurantId} />
                          </span>
                        </div>
