-- Script para crear la tabla de configuraciones de pago
-- Ejecutar en Supabase SQL Editor

-- 1. Crear la tabla restaurant_payment_settings
...
-- 7. Crear función para validar configuraciones de pago
...
-- 8. Crear función para obtener configuraciones de pago de un restaurante
...
-- 9. Crear función para guardar configuraciones de pago de un restaurante
...
-- 10. Crear función para verificar si un restaurante tiene pagos habilitados
...
-- 11. Crear función para obtener métodos de pago disponibles
...
-- 12. Verificar que la tabla se creó correctamente
SELECT 
    'Verificando creación de la tabla restaurant_payment_settings:' as info;
...
-- 15. Crear configuración por defecto para restaurantes existentes
SELECT 
    'Creando configuraciones por defecto para restaurantes existentes:' as info;
...
-- 16. Mostrar estadísticas finales
SELECT 
