-- Update Subscription Plans Permissions
-- This script updates the subscription plans to match the correct permissions:
-- - Trial and Starter: NO analytics, NO AI chat
-- - Pro and Multi: YES analytics, YES AI chat
...
-- 2. Update the plans with correct permissions
SELECT '2. UPDATING PLANS WITH CORRECT PERMISSIONS:' as section;

-- Update Free Trial Plan (NO analytics, NO AI chat)
...
SET 
    ...
    description = '14-day free trial with basic features (no analytics or AI chat)'
...
-- 7. Success message
SELECT '7. PERMISSIONS UPDATED:' as section;
SELECT '✅ Free Trial Plan: NO analytics, NO AI chat' as status;
SELECT '✅ Starter Plan: NO analytics, NO AI chat' as status;
SELECT '✅ Pro Plan: YES analytics, YES AI chat' as status;
SELECT '✅ Multi Plan: YES analytics, YES AI chat' as status;
SELECT '✅ All other features remain unchanged' as status;
