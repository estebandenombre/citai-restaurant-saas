-- Script rápido y simple para arreglar imágenes del hero
-- Ejecutar en Supabase SQL Editor

-- 1. Crear función simple de optimización
...
SELECT 
  'Hero images optimized' as status,
