-- Script SEGURO para corregir el acceso público a menús de restaurantes
-- Ejecutar en Supabase SQL Editor
-- Este script maneja políticas existentes sin errores
...
-- (DROP POLICY IF EXISTS no genera errores si la política no existe)
